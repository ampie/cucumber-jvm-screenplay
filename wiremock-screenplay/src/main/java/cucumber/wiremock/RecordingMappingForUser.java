...
public class RecordingMappingForUser  {
    ...
    public RecordingMappingForUser(String userScopeName, ExtendedMappingBuilder mappingBuilder) {
        ...
        this.userScopeId = IdGenerator.fromName(userScopeName);
    ...
    public void saveRecordings(VerificationScope executionScope) {
        ...
        wireMock.saveRecordingsForRequestPattern(WireMock.equalTo(executionScope.getScopePath() + '/' + this.userScopeId), requestPatternBuilder.build(), calculateRecordingDirectory(executionScope));
    }
    ...
    public void loadRecordings(VerificationScope executionScope) {
        ...
        if (recordingDirectory.exists()) {
            ...
            requestPatternBuilder.withHeader(HeaderName.ofTheCorrelationKey(), WireMock.equalTo(this.executionScope.getScopePath() + '/' + userScopeId));
