...
public class ScreenplayStepMethodInfo implements StepMethodInfo {
    ...
    public ScreenplayStepMethodInfo(String stepParentPath, String methodName, Object performer, Object origin) {
